...
- [x] PRD con objetivos / no-objetivos (`docs/01-requirements/mvp-streaming.md`)
- [x] Escenarios negativos / de abuso documentados (AB01–AB07)
- [x] Requisitos de seguridad mapeados a OWASP ASVS L1 (RS01–RS09)
